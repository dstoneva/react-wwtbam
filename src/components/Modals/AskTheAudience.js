...
const AskTheAudience = ({ answers, askTheAudienceUsed, setAskTheAudienceUsed, correctAnswer, incorrectAnswers }) => {
  ...
  return (
    <Modal isOpen={askTheAudienceUsed} style={{ width: "28rem", color: "black", height: "20rem" }}>
